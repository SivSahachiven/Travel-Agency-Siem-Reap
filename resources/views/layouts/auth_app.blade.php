...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="{{ asset('travel_agency/AdminLTE-3.2.0') }}/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="{{ asset('travel_agency/AdminLTE-3.2.0') }}/index2.html" class="h1"><b>Admin</b>LTE</a>
    </div>
    <div class="card-body">
      <p class="login-box-msg">Sign in to start your session</p>

      <form action="{{ asset('travel_agency/AdminLTE-3.2.0') }}/index3.html" method="post">
